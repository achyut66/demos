...
CREATE TABLE IF NOT EXISTS `anusuchi_8` (
  ...
  `cooridinator` varchar(255) NOT NULL,
...
--
-- Dumping data for table `dastur`
--

INSERT INTO `dastur` (`id`, `bapat`, `rate`, `remarks`) VALUES
(1, 'निवेदन दर्ता ', 100, ''),
(2, 'मुद्दा मिलापत्र ', 500, '');
...
INSERT INTO `letters` (`id`, `letter_name`, `dafa`, `letter_type`, `has_tok`, `status`) VALUES
(1, '1', 'दफा ८ को उपदफा (२) सँग सम्बन्धित', 'निबेदन पत्र वा उजुरीको ढाचा', 1, 0),
(2, '2', 'दफा ९ को उपदफा (१) सँग सम्बन्धित', 'उजुरी दर्ता निस्सा', 1, 0),
(3, '3', 'दफा ९ को उपदफा (२) सँग सम्बन्धित', 'तारिख भर्पाई', 0, 0),
(4, '4', 'दफा १५ को उपदफा (३) सँग सम्बन्धित', 'तारिख पर्चा', 0, 0),
(5, '5', 'दफा १६ को उपदफा (३) सँग सम्बन्धित', 'लिखित जवाफ / प्रति-उत्तर', 1, 0),
(6, '6', 'दफा २० को उपदफा (६) सँग सम्बन्धित', 'म्याद सुचना ', 0, 0),
(7, '7', 'दफा ४२ को उपदफा (१) सँग सम्बन्धित', 'निर्णय फाराम', 0, 1),
(8, '8', 'दफा ५२ को उपदफा (२) सँग सम्बन्धित ', 'अन्तरीम संरक्षणात्मक आदेश ', 0, 1),
(9, '9', 'दफा ५२ को उपदफा (५) सँग सम्बन्धित', 'मिलापत्रको लागी निवेदन संयुक्त दर्खास्थ पत्र', 1, 1),
(10, '10', 'दफा ५२ को उपदफा (६) सँग सम्बन्धित', 'मिलापत्रको ढाँचा', 1, 1),
(11, '11', 'दफा ५९ को उपदफा (३) सँग सम्बन्धित', 'मेलमिलापकर्ता सूचीकृत निवेदन', 0, 1),
(12, '12', 'दफा ७५ को उपदफा (१) सँग सम्बन्धित', 'भरिभराउ निवेदन ', 0, 1),
(13, '13', 'दफा ७६ को उपदफा (१) सँग सम्बन्धित', 'चलन चलाउने निवेदन', 0, 1),
(14, '14', 'दफा ८७ को उपदफा (६) सँग सम्बन्धित', 'सम्पति रोक्का को अदेश', 0, 1),
(15, '15', 'दफा ८९ को उपदफा (२) सँग सम्बन्धित', 'नक्कल प्रमाणित', 0, 1);
...
(6, 'दफा १४', 1),
(7, 'परिच्छद—३ को दफा १४', 1),
(8, 'परिच्छेद—३ को दफा १४', 1);
...
(4, 'ज्याफला मजदुरी नदिएको', '47', '1', 'घ'),
...
(14, 'सरकारी, सार्वजनिक वा सामुदायिक बाहेक एकाको हकको जग्गा अर्कोले चापी, मिची वा घुसाई खाएको', '47', NULL, 'ढ'),
(15, 'सरकारी, सार्वजनिक वा सामुदायिक बाहेक आफ्नो हक नपुग्ने अरुको जग्गामा घर वा कुनै संरचना बनाएको', '47', NULL, 'ण'),
(16, 'पति–पत्नीबीचको सम्बन्ध विच्छेद', '47', NULL, 'त '),
(17, 'अङ्भङ्ग बाहेकको बढीमा एक वर्षसम्म कैद हुन सक्ने कुटपिट', '47', NULL, 'थ'),
(18, 'गाली बेइज्जती', '47', NULL, 'द '),
(19, 'लुटपिट', '47', '2', 'च'),
...
CREATE TABLE IF NOT EXISTS `samati_name` (
  ...
  `samati_name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
(1, 'गल्छी गाउँपालिका', 'Galchhi Rural Municipality', 'गाउँ कार्यपालिकाको कार्यालय', 'Office of Municipality Executive', 'बागमती प्रदेश', 'Bagmati Province', 'धादिङ', 'Dhading', 'गल्छी', NULL, 'npl.png', 'changunarayan final logo_0.png', '-', 'A government big enough to give you everything you want is a government big enough to take from you everything you have.', 'https://www.changunarayanmun.gov.np/', 16614809, 'info@changunarayanmun.gov.np', 'https://www.facebook.com/', '2023-10-30 09:56:05am');
...
INSERT INTO `staff` (`id`, `name`, `designation`, `use_sign`, `mobile`, `email`, `status`, `remarks`) VALUES
(12, 'नर बहदुर बिश्वकर्मा', 'प्रमुख प्रशासकीय अधिकृत', NULL, '-', '-', '1', '');
...
(1, 'Superadmin', 'su', 1, 1, 1, 'BMS NEPAL', 'owner', 'galchhi', 'ac2920669e37acfdcadee51f01273217', 'info@lgtechco.net', 'Active', '9851117526', '2078-05-28', 1, '--', NULL, NULL, NULL);
